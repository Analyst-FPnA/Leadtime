...
with col[0]:
    ...
    create_pie_chart(df_pie, labels_column='Kategori Leadtime SJ', values_column='Nomor IT Kirim', title="OUTGOING BACKDATE", key='pie1')
with col[1]:
...
with col[0]:
    ...
    create_pie_chart(df_pie, labels_column='Kategori Leadtime RI', values_column='Nomor IT Terima', title="OUTGOING BACKDATE",key='pie2')
with col[1]:
